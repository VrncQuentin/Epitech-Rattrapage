...
export const UpdateSpaceXWidget = ({id, widgetMaker, title, children}) => {
    const select = useRef()
    const timer = useRef()
...
export const UpdateRocketInfo = ({id}) => (
    <UpdateSpaceXWidget id={id} title='Information about a Rocket model' widgetMaker={(value, timer) => {
        return ({
...
export const UpdateSpaceXInfo = ({id}) => (
    <UpdateSpaceXWidget id={id} rocketinfo={false} title='A fact about SpaceX' widgetMaker={(value, timer) => {
        return ({
